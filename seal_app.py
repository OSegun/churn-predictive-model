from seal_model import *
from seal_model import prediction
import streamlit as st
import pickle

cat_col = pickle.load(open("seal_married_fuga.pkl", "rb"))
...
def main():
    ...
    tigo = st.number_input("Insert The Tigo", value=2.0)
    ...
    regularity = st.number_input("Insert the ergularity", value=62.0)
    top_pack = st.selectbox("Insert your subscription pack", (cat_col["TOP_PACK"]))
    freq_top_pack = st.number_input("Insert the frequency pack number", value=11.0)
